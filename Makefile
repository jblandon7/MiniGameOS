...
OBJ = boot/kernel_entry.o boot/interrupts.o kernel/kernel.o kernel/vga.o kernel/graphics.o kernel/idt.o kernel/pic.o kernel/timer.o kernel/game.o kernel/keyboard.o
...
kernel/graphics.o: kernel/graphics.c
	$(CC) $(CFLAGS) -c kernel/graphics.c -o kernel/graphics.o
...
run: os.iso
	qemu-system-i386 -boot d -cdrom os.iso -no-reboot -no-shutdown
clean:
	rm -rf *.iso *.bin iso
